    ...
    <div className="home-page">
      <section className="home-intro">
        ...
        <div className="section-text">
          ...
          <p>
            Sourdough is a type of bread made using a natural fermentation process that involves wild yeast and lactic
            acid bacteria.
            ...
            Sourdough has been a traditional method of bread-making for thousands of years, predating modern yeast-based
            baking.
            It's prized for its complexity of flavor, artisanal quality, and the skill required to maintain a healthy
            starter and
      ...
      <section className="home-benefits">
        ...
        <div className="section-text">
          ...
          <p>
            ...
            The long fermentation process helps break down gluten, making the bread easier to digest for some people
            with
            gluten sensitivity (though it’s not suitable for those with celiac disease).
            The lactic acid bacteria in sourdough improve the availability of nutrients such as B vitamins, magnesium,
            and iron.
